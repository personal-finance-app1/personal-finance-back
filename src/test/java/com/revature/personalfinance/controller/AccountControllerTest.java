...
/*        when(accountService.updateAccount(account)).thenReturn(account);
    ...
    public void testUpdateAccountSuccess() {
        ResponseEntity<Account> returnedAccount = accountController.updateAccount("userId", account);
    ...
    public void testUpdateAccountFail() {
		...
		ResponseEntity<Account> returnedAccount = accountController.updateAccount("userId", badAccount);
        assertNotEquals(account,objectMapper.convertValue(returnedAccount.getBody(), Account.class));
    }
    
    @Test
    public void testUpdateAccountNull() {
    	ResponseEntity<Account> returnedAccount = accountController.updateAccount("userId", null);
        assertNull(objectMapper.convertValue(returnedAccount.getBody(), Account.class));
    }
}
